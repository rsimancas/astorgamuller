Ext.define('Muller.view.EstatusList', {
    extend: 'Ext.form.Panel',
    alias: 'widget.estatuslist',
    title: 'Estatus',
    // //width: 760,
    // //height: 300,
    // forceFit: true,
    ...
    initComponent: function() {
        ...
        var storeEstatus = Ext.create('Muller.store.Estatus').load();

        var storeTipos = Ext.create('Ext.data.Store', {
            fields: ['name'],
            data : [
                {code: "I", name: "IMPORTACION"},
                {code: "D", name: "DISTRIBUCION"}
            ]
        });
            ...
            items:[
            {
                    ...
                    editor: {
                        ...
                        listeners: {
                            ...
                            select: function(field, records, eOpts){
                                ...
                                if(field.value == "IMPORTACION") {
                                    record.set('EstatusTipo', "I");
                                } else {
                                    record.set('EstatusTipo', "D");
                                }
                            },
                            blur: function(field) {
                ...
                },
                {
                    ...
                    handler : function() {
                        ...
                        var r = Ext.create('Muller.model.Estatus');

                        grid.store.insert(count, r);
                        rowEditing.startEdit(count, 0);
                        rowEditing.editor.down('field[name=EstatusNombre]').focus(true, 200);
                    }
                }, 
                {
                    itemId: 'deleteline',
    ...
    onClickActionColumn: function(view, rowIndex, colIndex, item, e, record) {
        ...
        this.up('panel').editingPlugin.editor.down('field[name=EstatusNombre]').focus(true, 200);
    }
