Ext.define('Muller.view.EquiposList', {
    extend: 'Ext.form.Panel',
    alias: 'widget.equiposlist',
    title: 'Equipos',

    initComponent: function() {
        var me = this;

        var storeEquipos = Ext.create('Muller.store.Equipos').load();
            ...
            items:[
            {
                ...
                },
                {
                    ...
                    handler : function() {
                        ...
                        var r = Ext.create('Muller.model.Equipos');

                        grid.store.insert(count, r);
                        rowEditing.startEdit(count, 0);
                        rowEditing.editor.down('field[name=EquipoNum]').focus(true, 200);
                    }
                }, 
                {
                    itemId: 'deleteline',
    ...
    onClickActionColumn: function(view, rowIndex, colIndex, item, e, record) {
        ...
        this.up('panel').editingPlugin.editor.down('field[name=EquipoNum]').focus(true, 200);
    }
