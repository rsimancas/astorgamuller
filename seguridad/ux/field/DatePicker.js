 ...
 *
 */
Ext.define('Ext.ux.field.DatePicker', {
     ...
     */
    getValue: function() {
        if (this._picker && this._picker instanceof Ext.picker.Date && this._value !== null) {
    ...
    onChange: function(field, newValue, oldValue) {
        ...
        if(!Ext.isDate(value)) {
            me.hideClearIcon();
            me.element.addCls(Ext.baseCSSPrefix + 'field-select');
        } else {
            me.showClearIcon();
            me.element.removeCls(Ext.baseCSSPrefix + 'field-select');
        }
    },
