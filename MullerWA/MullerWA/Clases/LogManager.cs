namespace Utilidades
{
    ...
    public static class LogManager
    {
        ...
        public static string _filename = Path.Combine(_path, "MULLER-LOG" + DateTime.Now.ToString("yyyyMMdd HH") + ".txt");
        ...
        public static void Write(string text)
        {
            ...
            {
                _filename = Path.Combine(_path, "MULLER-LOG" + DateTime.Now.ToString("yyyyMMdd HH") + ".txt");
            }
