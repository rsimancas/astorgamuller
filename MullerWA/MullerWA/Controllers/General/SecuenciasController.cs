...
namespace MullerWA.Controllers
{
    ...
    {
        static readonly ISecuenciasRepository repository = new SecuenciasRepository();
        ...
        public object Put(Secuencias updated)
        {
            object json;
            ...
            {
                string messageError = "";
                Secuencias putting = repository.Update(updated, ref messageError);
