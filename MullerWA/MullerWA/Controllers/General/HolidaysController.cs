...
namespace MullerWA.Controllers
{
    ...
    {
        static readonly IHolidaysRepository repository = new HolidaysRepository();
        ...
        public object GetAll()
        {
            ...
            try
            {
                ...
                {
                    string msgError = "";
                    Holiday estatus = repository.Get(id, ref msgError);
        ...
        public object Delete(Holiday deleted)
        {
            string msgError = "";
