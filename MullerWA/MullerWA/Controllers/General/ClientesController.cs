...
namespace MullerWA.Controllers
{
    ...
    {
        static readonly IClientesRepository repository = new ClientesRepository();
        ...
        public object Put(Cliente cliente)
        {
            ...
            {
                string messageError = "";
                cliente.ClienteModificado = DateTime.Now;
                Cliente putting = repository.Update(cliente, ref messageError);
        ...
        public object Delete(Cliente cliente)
        {
            string msgError = "";
