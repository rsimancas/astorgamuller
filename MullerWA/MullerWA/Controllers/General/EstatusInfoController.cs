...
namespace MullerWA.Controllers
{
    ...
    [TokenValidation]
    public class EstatusInfoController : ApiController
    {
        static readonly IEstatusInfoRepository repository = new EstatusInfoRepository();
        ...
        public object Put(EstatusInfo updated)
        {
            object json;
            ...
            {
                string messageError = "";
                EstatusInfo putting = repository.Update(updated, ref messageError);
