Ext.define('Muller.view.admin.GastosItemsList', {
    extend: 'Ext.form.Panel',
    alias: 'widget.gastositemslist',
    title: 'Items de Gastos',
    // //width: 760,
    // //height: 300,
    // forceFit: true,
    // bodyPadding: 10,
    ...
    initComponent: function() {
        ...
        var storeGastosItems = Ext.create('Muller.store.admin.GastosItems').load();
        var storeGastosGruposItems = Ext.create('Muller.store.admin.GastosGruposItems',{pageSize:0}).load();
        ...
        Ext.applyIf(me, {
            items:[
            {
                ...
                },
                {
                    xtype: 'gridcolumn',
                    flex: 1,
                    dataIndex: 'GItemNombre',
                    text: 'Clasificación',
                    editor: {
                        xtype:'combo',
                        displayField: 'GGrupoItemNombre',
                        valueField: 'GGrupoItemId',
                ...
                },
                {
                    ...
                    handler : function() {
                        ...
                        var r = Ext.create('Muller.model.admin.GastosItems');

                        grid.store.insert(count, r);
                        rowEditing.startEdit(count, 0);
                        rowEditing.editor.down('field[name=GItemNombre]').focus(true, 200);
                    }
                }, 
                {
                    itemId: 'deleteline',
    ...
    onClickActionColumn: function(view, rowIndex, colIndex, item, e, record) {
        ...
        this.up('panel').editingPlugin.editor.down('field[name=GItemNombre]').focus(true, 200);
    }
