Ext.define('Muller.view.SecuenciasList', {
    extend: 'Ext.form.Panel',
    alias: 'widget.secuenciaslist',
    title: 'Secuencias',

    initComponent: function() {
        var me = this;

        var storeSecuencias = Ext.create('Muller.store.Secuencias').load();
            ...
            items:[
            {
                ...
                },
                {
                    ...
                    handler : function() {
                        ...
                        var r = Ext.create('Muller.model.Secuencias');
