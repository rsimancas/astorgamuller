Ext.define('Muller.store.admin.GastosDetalle', {
    ...
    requires: [
        'Muller.model.admin.GastosDetalle'
    ],
    ...
    constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            model: 'Muller.model.admin.GastosDetalle',
            //storeId: 'GastosDetalletore',
            remoteSort: true,
            proxy: {
                type: 'rest',
                url: '../wa/api/GastosDetalle',
                headers: {
